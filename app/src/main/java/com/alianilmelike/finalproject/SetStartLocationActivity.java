...
public class SetStartLocationActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, View.OnClickListener{

    Button setStartLocation;
    public static String KEY_STRING_START ="asdf";
    public static String START_KEY_LATITUDE = "startLatitude";
    public static String START_KEY_LONGITUDE = "startLongitude";
    private GoogleMap mMap;
    private GoogleApiClient mGoogleApiClient;
    private Location mLastLocation;
    public double mstartLatitude, mstartLongitude;

    public void SetStartLocationActivity(){
        //Am I need to do something here? TODO
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_set_start_location);
        setStartLocation = (Button) findViewById(R.id.setStartLocationButton);
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (mLastLocation != null) {
            mstartLatitude = mLastLocation.getLatitude();
            mstartLongitude = mLastLocation.getLongitude();
...
//
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.setStartLocationButton:
                Intent i = new Intent();
                Toast.makeText(getApplicationContext(),mstartLatitude + "Seted",Toast.LENGTH_SHORT).show();
                i.putExtra(START_KEY_LATITUDE, mstartLatitude);
                i.putExtra(START_KEY_LONGITUDE,mstartLongitude);
